...
class PropietarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return match ($userId ? 'PUT' : $this->method()) {
            ...
            'cedula' => [
                ...
                'string',
                'max:20',
                Rule::unique('propietarios') // Asegura que la cédula sea única en la tabla propietarios
            ],
        ...
        'PUT' => [
            'cedula' => [
                ...
                'string',
                'max:20',
                Rule::unique('propietarios')->ignore($this->id) // Ignora el usuario actual en la actualización
            ],
            'primer_nombre' => 'required|string|max:50',
            'segundo_nombre' => 'nullable|string|max:50',
            'apellidos' => 'required|string|max:100',
    ...
    public function messages(): array
    {
        return [
            ...
            'cedula.unique' => 'Ya existe un propietario con esta cédula',
